    ...
    <Layout title="Contact">
      <div className="bg-white text-center shadow-xl p-8 w-80 rounded">
        ...
        <div className="mt-4">
          ...
          <p className="text-xs mt-2 text-gray-600">billie@example.com</p>
          <p className="font-bold mt-3">Phone</p>
          <p className="text-xs mt-2 text-gray-600">000-123-456</p>
          <p className="font-bold mt-3">Twitter</p>
          <p className="text-xs mt-2 text-gray-600">https://twitter.com/naoto_BIG3</p>
        </div>
        <div className="mt-6 flex justify-around">
          <div>
            <a
              href="https://twitter.com/naoto_BIG3"
              target="_blank"
